...
class LiveStreamExample {
  static void demonstrateTokenFlow() async {
    ...
    try {
      ...
      print('   👥 Audience 1 (UID: 200001): ${audience1Token.token.substring(0, 30)}...');
      ...
      print('   👥 Audience 2 (UID: 200002): ${audience2Token.token.substring(0, 30)}...');
      ...
      print('   👥 Audience 3 (UID: 200003): ${audience3Token.token.substring(0, 30)}...');
